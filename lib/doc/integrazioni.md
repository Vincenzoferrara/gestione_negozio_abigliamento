...
- MGWS gestisce checkout POS, resi/cambi vincolati, turno cassa server-side opzionalmente obbligatorio, impostazioni POS globali, impostazioni utente app, dipendenti gestionali con stipendio in centesimi/valuta, stock gestionale, carico rapido, fornitori, riordino, ordini fornitore, ricezione/convalida, movimenti, inventario fisico e loyalty v1
