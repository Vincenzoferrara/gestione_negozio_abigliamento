...
//
// Widget per lo scanner di barcode/QR nella cassa.
// Modulo centralizzato: tutti i punti dell'app (cassa, carta fedeltà, ecc.)
// devono usare showBarcodeScanner() / BarcodeScannerDialog da qui.
// lib/QRcode/barcode_scanner.dart è un re-export shim di questo file.

import 'package:flutter/material.dart';
import 'package:mobile_scanner/mobile_scanner.dart';
import '../../theme/theme.dart';

/// Dialog per lo scanner di barcode/QR
            ...
            SizedBox(
              ...
              child: Stack(
                children: [
                  ...
                  CustomPaint(
                    painter: ScannerOverlayPainter(primaryColor: theme.primaryColor),
                    child: Container(),
                  ),
                ...
                children: [
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (context, value, child) {
                      final bool isTorchAvailable = value.torchState != TorchState.unavailable;
...
/// Funzione helper per aprire lo scanner come dialog
