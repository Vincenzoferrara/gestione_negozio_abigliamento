...
/// ```
/// NOTA (patch locale): vedi `_parsePrice` in
/// `src/variation/models/variation.dart`. Stessa tolleranza qui: i prezzi
/// possono arrivare come stringhe, numeri JSON o null.
double? _parseProductPrice(dynamic value) {
...
class WooProduct {
  ...
  WooProduct.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        sku = json['sku'],
        price = _parseProductPrice(json['price']),
        regularPrice = _parseProductPrice(json['regular_price']),
        salePrice = _parseProductPrice(json['sale_price']),
