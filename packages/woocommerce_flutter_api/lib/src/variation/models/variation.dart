...
/// NOTA (patch locale): i prezzi WooCommerce arrivano di solito come stringhe
/// ("20.00"), ma alcuni store/importazioni li restituiscono come numeri JSON
/// o null. `double.tryParse` accetta solo String e lancia TypeError negli
/// altri casi, abbattendo l'intera lista di varianti. Parsifichiamo in modo
/// tollerante: String -> tryParse, num -> toDouble, resto -> null.
...
class WooProductVariation {
  ...
  WooProductVariation.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        status = WooProductStatus.fromString(json['status'] as String? ?? ''),
        ...
        regularPrice = _parsePrice(json['regular_price']),
        salePrice = _parsePrice(json['sale_price']),
        onSale = json['on_sale'],
        purchasable = json['purchasable'],
        virtual = json['virtual'],
        downloadable = json['downloadable'],
        downloads = (json['downloads'] as List? ?? const [])
            .map((i) => WooProductDownload.fromJson(i))
            .toList(),
        downloadLimit = json['download_limit'],
        downloadExpiry = json['download_expiry'],
        taxStatus = WooProductTaxStatus.fromString(json['tax_status'] as String? ?? ''),
        ...
        stockStatus = WooProductStockStatus.fromString(
            json['stock_status'] as String? ?? ''),
        backorders = WooProductBackorder.fromString(
        ...
        dimensions = json['dimensions'] != null &&
            ...
            ? WooProductDimension.fromJson(json['dimensions'])
            : const WooProductDimension(),
        ...
        attributes = (json['attributes'] as List? ?? const [])
            ...
            .toList(),
        metaData = (json['meta_data'] as List? ?? const [])
